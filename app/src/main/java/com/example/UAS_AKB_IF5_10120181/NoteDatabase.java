...
public class NoteDatabase extends SQLiteOpenHelper {
    ...
    public long addNote(com.example.UAS_AKB_IF5_10120181.Note note){
    ...
    public com.example.UAS_AKB_IF5_10120181.Note getNote(long id){
        ...
        return new com.example.UAS_AKB_IF5_10120181.Note(Long.parseLong(cursor.getString(0)),cursor.getString(1),cursor.getString(2),cursor.getString(3),
                cursor.getString(4), cursor.getString(5));

    }
    public List<com.example.UAS_AKB_IF5_10120181.Note> getNotes(){
        SQLiteDatabase db = this.getReadableDatabase();
        List<com.example.UAS_AKB_IF5_10120181.Note> allNotes = new ArrayList<>();
        ...
        if (cursor.moveToFirst()){
            do {
                com.example.UAS_AKB_IF5_10120181.Note note = new com.example.UAS_AKB_IF5_10120181.Note();
    ...
    public int editNote(com.example.UAS_AKB_IF5_10120181.Note note){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues c = new ContentValues();
